...
from ..tf1.fmpc_tf1_jvp import build_tf1_input
...
class FMPCEFExploratoryProbeConfig:
    """Configuration for the first post-TF2 teacher-free exploratory core probe."""
...
def _config_payload(config: FMPCEFExploratoryProbeConfig) -> dict[str, Any]:
    return {
        "phase": "post_tf2_exploratory",
        "stage": "teacher_free_fmpc_ef_exploratory_probe",
        "dataset": {
...
def run_fmpc_ef_exploratory_probe(
    ...
    """Run the first post-TF2 exploratory teacher-free core probe."""
