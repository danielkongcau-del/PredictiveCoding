...
from ..transport_core_v1.fmpc_tf1_flow import build_tf1_context, hidden_states_from_state, rollout_hidden_transport
...
class FMPCTF2ReadoutRefitSuiteConfig:
    ...
    reference_summary_path: str | Path = "outputs/incremental_bridge/fmpc_tf2_gap_decomposition_suite/aggregate_summary.json"
