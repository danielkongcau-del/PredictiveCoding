...
from ..stage_03_transport_core_v1.fmpc_tf1 import (
...
from ..stage_03_transport_core_v1.fmpc_tf1_jvp import (
    forward_tf1_mlp_with_jvp,
    resolve_tf1_identity_tangent_mode,
)
from ..stage_02_interval_velocity.fmpc_meanflow_jvp import MeanFlowMLPJVPResult
...
class FMPCTF2Config:
    ...
    def __post_init__(self) -> None:
        if self.dataset_name != "digits":
            raise ValueError("FMPC Stage 04 Incremental Bridge currently supports digits only.")
