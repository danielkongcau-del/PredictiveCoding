...
from ..tf1.fmpc_tf1_jvp import (
    forward_tf1_mlp_with_jvp,
    resolve_tf1_identity_tangent_mode,
)
from ..interval_meanflow.fmpc_meanflow_jvp import MeanFlowMLPJVPResult
...
class FMPCTF2Config:
    ...
    def __post_init__(self) -> None:
        if self.dataset_name != "digits":
            raise ValueError("Phase TF2 currently supports digits only.")
