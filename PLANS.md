...
- the same Stage 05 v2 family with a stronger `192`-epoch budget materially improves:
...
- if Stage 05 continues, run the next narrow budget push beyond the current `192`-epoch reference on the same:
