...
from pc.stage_04_incremental_bridge.fmpc_tf2_terminal_step_supervision_split_suite import (
...
def main() -> None:
    result = run()
    print("FMPC Stage 04 Incremental Bridge terminal-step supervision split suite completed.")
