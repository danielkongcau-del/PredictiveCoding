...
from pc.exploratory.fmpc_ef_exploratory_probe import (
...
def run(
    ...
    **overrides: object,
    ...
    """Run the first post-TF2 teacher-free exploratory core probe on digits."""
...
def main() -> None:
    result = run()
    print("Post-TF2 teacher-free exploratory probe completed.")
