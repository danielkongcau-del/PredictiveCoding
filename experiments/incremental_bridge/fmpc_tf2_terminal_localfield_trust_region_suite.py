...
from pc.incremental_bridge.fmpc_tf2_terminal_localfield_trust_region_suite import (
...
def main() -> None:
    result = run()
    print("Phase Incremental Bridge terminal local-field trust-region suite completed.")
