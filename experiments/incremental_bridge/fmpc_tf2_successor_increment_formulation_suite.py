...
from pc.incremental_bridge.fmpc_tf2_successor_increment_formulation_suite import (
...
if __name__ == "__main__":
    result = run()
    print("Phase Incremental Bridge successor-increment formulation source-localization suite completed.")
