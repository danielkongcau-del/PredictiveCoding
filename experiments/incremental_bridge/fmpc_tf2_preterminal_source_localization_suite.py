...
from pc.incremental_bridge.fmpc_tf2_preterminal_source_localization_suite import (
...
if __name__ == "__main__":
    result = run()
    print("Phase Incremental Bridge preterminal-update source-localization suite completed.")
