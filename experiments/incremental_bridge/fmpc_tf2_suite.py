...
from pc.incremental_bridge.fmpc_tf2_suite import FMPCTF2SuiteConfig, FMPCTF2SuiteRunResult, run_fmpc_tf2_suite
...
def main() -> None:
    result = run()
    print("Phase Incremental Bridge iFMPC bridge suite completed.")
