...
from pc.incremental_bridge.fmpc_tf2_unified_cone_robustness_suite import (
...
def run(
    ...
    hard_shape_source_root: str | Path = "outputs/incremental_bridge/fmpc_tf2_unified_cone_shape_suite",
    smooth_source_root: str | Path = "outputs/incremental_bridge/fmpc_tf2_smooth_unified_cone_suite",
) -> FMPCTF2UnifiedConeRobustnessSuiteRunResult:
