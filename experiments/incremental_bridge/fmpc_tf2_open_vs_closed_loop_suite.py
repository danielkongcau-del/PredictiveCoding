...
from pc.incremental_bridge.fmpc_tf2_open_vs_closed_loop_suite import (
...
def main() -> None:
    result = run()
    print("Phase Incremental Bridge open-vs-closed-loop trajectory coupling suite completed.")
