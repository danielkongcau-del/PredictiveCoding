...
from pc.stage_03_transport_core_v1.fmpc_tf1_flow import FMPCTF1StateFeatureTangents, build_tf1_context
from pc.stage_03_transport_core_v1.fmpc_tf1_jvp import build_tf1_input_tangent, resolve_tf1_identity_tangent_mode
from pc.stage_04_incremental_bridge.fmpc_tf2 import _make_pc_model, _make_psi_network, _plan_tf2_micro_step, build_tf2_canonical_config
