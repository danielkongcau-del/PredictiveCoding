...
- reference budget epochs: `48`
- stronger budget epochs: `96`
...
## Supports
- The stronger-budget Stage 05 v2 candidate materially improves configured-step mechanism magnitude over the 48-epoch reference.
- The stronger-budget Stage 05 v2 candidate materially improves report-only accuracy over the 48-epoch reference.
- The stronger budget still hits the final training boundary on every seed.
- 48-epoch reference configured-step validation energy delta vs identity mean: -0.000290623305.
- 96-epoch candidate configured-step validation energy delta vs identity mean: -0.000519002926.
- 48-epoch reference validation/test accuracy means: 0.562963 / 0.544444.
- 96-epoch candidate validation/test accuracy means: 0.648148 / 0.655556.
